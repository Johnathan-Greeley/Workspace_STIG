...
import os, datetime, SecureCRT, array, sys, re, xml.sax.saxutils, string, csv, inspect, time
from datetime import date
from collections import OrderedDict
from packaging import version
import xml.etree.ElementTree as ET
import xml.sax.saxutils as escape
...
def process_host(host, stig_template, log_file):
    ...
    device_type = "IOS"
    stig_list = []
    stig_vul_list = "stig_vul.csv"
    stig_device_list = "hosts.txt"
    stig_vul_list = read_function_names(strFilePath + stig_vul_list)
...
def log_check_results(obj, ckl, host, device_name, common_name, log_file):
    finding_details = escape(obj.finding)
        ...
        for stig_data in vuln.findall('STIG_DATA'):
            ...
            if vuln_attribute is not None and vuln_attribute.text == 'Vuln_Num':
                ...
                if attribute_data is not None and attribute_data.text == obj.vulid:
                    ...
                    vuln.find('FINDING_DETAILS').text = finding_details
